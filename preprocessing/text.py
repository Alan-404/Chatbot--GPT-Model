...
class SignHandler:
    ...
    def __sign_to_text(self, sequence: str):
    ...
    def sign(self, sequences: list, start_token: bool, end_token: bool):
    ...
    def sign_to_text(self, sequences: list):
        for index in range(len(sequences)):
...
class Replacer:
    ...
    def __replace_standard(self, sequence: str):
        for (pattern, repl) in self.replace_patterns:
            sequence = re.sub(pattern, repl, sequence)

        return sequence

    def __word_is_handle(self, sequence: str):
        patterns = ['he', 'she', 'it']
    ...
    def replace(self, sequences: list):
        for index in range(len(sequences)):
...
class Tokenizer:
    ...
    def __save_tokenizer(self, tokenizer_path: str = None):
    ...
    def __tokenize(self, sequence: str):
        for text in sequence.split(' '):
            self.add_token(text)

    def get_index_token(self, index: int):
...
class TextProcessor:
    def __init__(self, tokenizer_path: str = None, filters: str = '[@!*?|\/~`]', remove_stop_words: bool = False):
    ...
    def process(self, sequences: list, max_len: int, padding: str = 'post', truncating: str = "post", start_token: bool = False, end_token: bool = False):
